...
mslearn: https://learn.microsoft.com/en-us/training/modules/manage-azure-resources-windows-powershell/3-manage-azure-virtual-machines-by-using-windows-powershell-commands
tags:
  - powershell
  - azure-vm
  - vm-size
  - managed-disks
  - resource-group
prev: "[[0.1.3.2 Create a new Azure virtual machine by using Windows PowerShell commands]]"
next: "[[0.1.3.4 Manage Azure related storage by using Azure PowerShell]]"
---

Besides using [[Glossary#Windows PowerShell|Windows PowerShell]] to create new Azure VMs, you can also use PowerShell commands to manage, modify, and remove Azure VMs and the resources related to Azure VMs. This topic covers some of the most common tasks for managing and modifying Azure VMs with PowerShell.
...
During the lifecycle of a VM, you might want to run management tasks such as starting, stopping, or deleting a VM. Additionally, you might want to create scripts to automate repetitive or complex tasks. You can use [[Glossary#Azure PowerShell|Azure PowerShell]] to perform many common management tasks by using the command line or scripts.
