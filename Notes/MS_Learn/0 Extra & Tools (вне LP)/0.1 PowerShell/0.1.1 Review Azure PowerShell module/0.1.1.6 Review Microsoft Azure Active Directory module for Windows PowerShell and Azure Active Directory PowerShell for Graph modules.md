...
> **Additional reading:** For more information about the cmdlets related to Microsoft Entra ID in the PowerShell for Graph, refer to [Microsoft Graph PowerShell](https://learn.microsoft.com/en-us/powershell/microsoftgraph/overview?view=graph-powershell-1.0).
