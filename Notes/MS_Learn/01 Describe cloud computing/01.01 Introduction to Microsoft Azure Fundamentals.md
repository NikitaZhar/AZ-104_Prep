...
tags:
  ...
  - azure-fundamentals
  - az-900
next: "[[01.02 Introduction to cloud computing]]"
---
...
In this series, you cover cloud computing basics, get introduced to some of the core services provided by Microsoft Azure, and learn more about the governance and compliance services that you can use. ![Diagram showing Azure at the center with six core service categories: Compute, Storage, Networking, Databases, AI and ML, and IoT.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-cloud-compute/media/azure-services-diagram.png)
