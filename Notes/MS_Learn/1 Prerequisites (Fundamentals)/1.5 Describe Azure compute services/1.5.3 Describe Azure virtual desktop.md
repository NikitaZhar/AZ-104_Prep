...
prev: "[[1.5.2 Describe Azure virtual machines]]"
next: "[[1.5.4 Describe Azure containers]]"
---
...
- It centralizes desktop and app delivery in Azure and integrates with [[Glossary#Microsoft Entra ID|Microsoft Entra ID]] for identity and access controls.
