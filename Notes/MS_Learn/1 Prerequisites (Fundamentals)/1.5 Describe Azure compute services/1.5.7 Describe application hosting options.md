...
module: "[[1.5 Describe Azure compute services]]"
tags:
  - azure-app-service
  - web-apps
  - api-apps
  - webjobs
  - mobile-apps
prev: "[[1.5.6 Describe AI, machine learning, and IoT Edge services in Azure]]"
next: "[[1.5.8 Summary]]"
---
...
![Diagram showing hosting spectrum from VMs with more control, to containers, to App Service with less operational effort.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-compute-networking-services/media/application-hosting-spectrum.png)
