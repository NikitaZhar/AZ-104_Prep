...
tags:
  ...
  - azure-rbac
  - azure-account
prev: "[[1.4.4 Describe Azure physical infrastructure]]"
next: "[[1.4.6 Summary]]"
---
...
Using Azure requires an Azure subscription. A subscription provides access to Azure products and services and serves as a billing unit. An Azure subscription links to an Azure account, which is an identity in [[Glossary#Microsoft Entra ID|Microsoft Entra ID]] or in a directory that [[Glossary#Microsoft Entra ID|Microsoft Entra ID]] trusts.
