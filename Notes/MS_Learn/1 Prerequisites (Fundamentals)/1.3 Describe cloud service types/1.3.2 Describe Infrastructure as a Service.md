...
prev: "[[1.3.1 Introduction]]"
next: "[[1.3.3 Describe Platform as a Service]]"
---
...
![Diagram comparing IaaS, PaaS, and SaaS responsibility stacks showing which layers are managed by the customer versus the cloud provider.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-cloud-service-types/media/cloud-service-types-comparison.png)
...
![Diagram showing IaaS responsibility split with customer managing OS through applications and provider managing physical infrastructure, plus common scenarios.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-cloud-service-types/media/describe-infrastructure-service.png)
