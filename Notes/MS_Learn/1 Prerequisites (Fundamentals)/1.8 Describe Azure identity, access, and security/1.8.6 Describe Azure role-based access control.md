...
tags:
  - azure-rbac
prev: "[[1.8.5 Describe Azure conditional access]]"
next: "[[1.8.7 Describe Zero Trust model]]"
---
...
You typically access Resource Manager from the Azure portal, Azure Cloud Shell, [[Glossary#Azure PowerShell|Azure PowerShell]], and the Azure CLI. Azure RBAC doesn't enforce access permissions at the application or data level. Application security must be handled by your application.
