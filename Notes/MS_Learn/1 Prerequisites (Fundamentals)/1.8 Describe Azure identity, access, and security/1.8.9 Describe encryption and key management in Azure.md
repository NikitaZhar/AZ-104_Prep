...
tags:
  - encryption
  - azure-key-vault
prev: "[[1.8.8 Describe defense-in-depth]]"
next: "[[1.8.10 Describe Microsoft Defender for Cloud]]"
---
...
![Diagram showing encryption at rest protecting databases, disks, and storage, and encryption in transit protecting data moving between application tiers and users, with Azure Key Vault managing secrets, encryption keys, and certificates for both.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-identity-access-security/media/encryption-key-management-option-split.png)
