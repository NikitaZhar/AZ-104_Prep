...
tags:
  ...
  - b2b
  - guest-access
prev: "[[1.8.3 Describe Azure authentication methods]]"
next: "[[1.8.5 Describe Azure conditional access]]"
---
...
The external identity provider manages authentication, and you manage authorization to your applications with [[Glossary#Microsoft Entra ID|Microsoft Entra ID]] or Azure AD B2C.
...
With [[Glossary#Microsoft Entra ID|Microsoft Entra ID]], you can enable collaboration across tenant boundaries by using B2B features. Guest users from other tenants can be invited by administrators or authorized users. This capability also applies to social identities such as Microsoft accounts.

You also can easily ensure that guest users have appropriate access. You can ask the guests themselves or a decision maker to participate in an access review and recertify (or attest) to the guests' access. The reviewers can give their input on each user's need for continued access, based on suggestions from [[Glossary#Microsoft Entra ID|Microsoft Entra ID]]. When an access review is finished, you can then make changes and remove access for guests who no longer need it.
