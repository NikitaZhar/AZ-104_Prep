...
prev: "[[1.2.2 Describe the benefits of high availability and scalability in the cloud]]"
next: "[[1.2.4 Describe the benefits of security and governance in the cloud]]"
---
...
![Diagram showing reliability through multi-region failover with decentralized design across regions.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-benefits-use-cloud-services/media/reliability.png)
...
![Diagram showing predictability with performance and cost cards listing autoscaling, load balancing, real-time tracking, and pricing tools.](https://learn.microsoft.com/en-us/training/wwl-azure/describe-benefits-use-cloud-services/media/predictability.png)
